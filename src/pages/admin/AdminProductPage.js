    ...
    return (
        <>
            {isLoading ? (
                ...
                <>
                    <div className="forms-container">
                        ...
                        <div className="form-section">
                            ...
                            <select name="productChildCategoryId" onChange={handleInputChange} id=""
                                    className="form-input">
                                <option id={""} key={"index"}></option>
                        ...
                        <div style={{display: "none"}} className="form-section">
                ...
                // Render content for other roles or unauthorized users
